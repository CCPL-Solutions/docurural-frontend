...
export type FiltersBottomSheetResult = { action: 'apply'; draft: DocumentFilters } | undefined;
...
export class DocumentFiltersBottomSheetComponent {
  ...
  private readonly ref =
    inject<MatBottomSheetRef<DocumentFiltersBottomSheetComponent, FiltersBottomSheetResult>>(
      MatBottomSheetRef,
    );
